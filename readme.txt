...
WP Faster is a performance tuning plugin, removing lots of default WordPress behaviour.

== Description ==

WP Faster is a performance tuning plugin, removing lots of default WordPress behaviour, such as filters, actions, injected code, native code and third-party actions.

== Installation ==

1. Copy the `/WPFaster /` folder into your `/wp-content/plugins/` directory
2. Activate the plugin
3. Go to Settings -> WP Faster and start optimizing

== Changelog ==

= 4.0.0 =
* TODO: Remove Proxima Vara custom font
* TODO: Only load Thin UI on WP Faster pages to prevent conflicts with other elhaddajiotmane plugins

= 3.9.9 =
* UPDATE: Only load ChartJS on WP Faster pages to prevent conflicts with other elhaddajiotmane plugins
...
= 3.4.6 =
* FEATURE: Added Chrome User Experience Report (needs a Google WP Faster API key)
...
* UPDATE: Removed `wpfaster _clean_attributes` option, as WordPress 5.3 adds theme support for this
...
* UPDATE: Updated WordPress recommendations
* UPDATE: Updated WordPress compatibility
* FEATURE: Exposed Site Health in WP Faster Settings screen
* COMPATIBILITY: Removed several pre-WordPress-5.0 options
...
* UPDATE: Removed Zen notice from pages other than WP Faster settings page
* UPDATE: Updated server software recommendations
* UPDATE: Updated WordPress recommendations
